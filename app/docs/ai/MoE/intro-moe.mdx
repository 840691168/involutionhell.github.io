...
![[Pasted image 20250915164841.png]]
...
![[Pasted image 20250915165750.png]]

---

## Routing 机制：Dense MoE 与 Sparse MoE

![[Pasted image 20250915162101.png]]
...
论文 [*Pushing Mixture of Experts to the Limit: Extremely Parameter Efficient MoE for Instruction Tuning*](https://arxiv.org/abs/2309.05444) 首次提出将 **LoRA 类型的 PEFT 方法和 MoE 框架结合**。  
...
![[Pasted image 20250920101218.png]]
